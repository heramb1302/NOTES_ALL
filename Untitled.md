Here’s a **powerful, production-level “Antigravity Agent” prompt** you can use with any LLM (GPT / Gemini / Claude) to **generate your entire hackathon system cleanly, correctly, and fast**.
...
- Generate **Colab + FastAPI + Frontend**
    
- Handle **file structure + README**
    
- Respect your special rule about **Colab → local files**
...
Copy everything below and use it as your master prompt:
...
- If output is too long → say:  
    👉 _“Continue from backend section”_
    

---

If you want, I can next:  
✅ Generate the **actual full code using this prompt**  
✅ Or simplify it into a **1-hour hackathon version (ultra-fast build)**